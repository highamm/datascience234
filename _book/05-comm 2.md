# Communication with `RMarkdown` and `ggplot2`
...
<img src="05-comm_files/figure-html/unnamed-chunk-5-1.png" width="672" />
...
There are so many `Markdown` options, but most of the time, if you want to do something specific, you can just Google it. The purpose of what follows is just to get us familiar with the very basics and things you will probably use most often. It will be more helpful if you use the .Rmd, not the .html, file to follow along with this section.

__Bullet Points and Sub-bullet Popints__: Denoted with a `*` and `-`, respectively. The sub bullets should be indented by 4 spaces.
...
There's a lot of other stuff to explore: <a href="https://rstudio.com/wp-content/uploads/2015/03/rmarkdown-reference.pdf" target="_https://rstudio.com/wp-content/uploads/2015/03/rmarkdown-reference.pdf</a>.
...
The biggest thing that you can take advantage of with YAML is themes that other people have written for `R Markdown`. By default, you're just using `R Markdown`'s default theme, which looks okay. 
...
<img src="05-comm_files/figure-html/unnamed-chunk-18-1.png" width="672" />
...
We want to use our graphics to communicate with others as clearly as possible. We also want to be as inclusive as possible in our communications. This means that, if we choose to use colour, our graphics should be made so that a colour-vision-deficient (CVD) person can read our graphs. About 4.5% of people are colour vision deficient, so it's actually quite likely that a CVD person will view the graphics that you make (depending on how many people you share it with) <http://www.colourblindawareness.org/colour-blindness/#:~:text=What%20is%20colour%20blindness%3F,most%20of%20whom%20are%20male>

The colour scales from `R Colour Brewer` are readable for common types of CVD. A list of scales can be found here: <https://www.datanovia.com/en/wp-content/uploads/dn-tutorials/ggplot2/figures/0101-rcolorbrewer-palette-rcolorbrewer-palettes-1.png> 
...
<img src="05-comm_files/figure-html/unnamed-chunk-26-1.png" width="672" />
...
<img src="05-comm_files/figure-html/unnamed-chunk-27-1.png" width="672" />
...
<img src="05-comm_files/figure-html/unnamed-chunk-28-1.png" width="672" />
...
<img src="05-comm_files/figure-html/unnamed-chunk-29-1.png" width="672" />

### Plot Themes 

Plot themes are an easy way to change many aspects of your plot with an overall theme that someone developed. The default theme for `ggplot2` graphs is `theme_grey()`, which is the graph with the grey background that we've been using in the entirety of this class. The 7 other themes are given in `R` for Data Science <a href="https://r4ds.had.co.nz/graphics-for-communication.html#themes" target="_blank">https://r4ds.had.co.nz/graphics-for-communication.html#themes</a> in Figure 28.3.
...
There's still __much__ more you can do with `ggplot2`. In fact, there are entire <a href="http://moderngraphics11.pbworks.com/f/ggplot2-Book09hWickham.pdf" target="_blank">books on it</a>. But, for any other specialization, you can usually use Google to help you!
...
<img src="05-comm_files/figure-html/unnamed-chunk-31-1.png" width="672" />
