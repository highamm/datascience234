...
```{r, echo = FALSE}
## R only allows you to input code and comments while R Markdown integrates
...
```{r, echo = FALSE}
## When using R Markdown, all code must run for the document to knit. 
...
## with the data. You don't see if outliers were taken out. R Markdown
...
## the rows, they are gone forever. In R Markdown, filter() makes it easy
